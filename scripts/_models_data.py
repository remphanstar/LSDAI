...
model_list = {
    ...
    "PornMaster-Pro FULL-V4-inpainting": {"url": "https://civitai.com/api/download/models/102709", "name": "pornmasterProFULLV4_fullV4-inpainting.safetensors", "inpainting": True},
    ...
    "PornMaster-Pro FULL-V5-inpainting": {"url": "https://civitai.com/api/download/models/176934", "name": "pornmasterProFULLV5_fullV5-inpainting.safetensors", "inpainting": True},
...
lora_list = {
    ...
    "PornMaster-Selfie/masturbation Concepts - V2-LYCORIS": [{'url': "https://civitai.com/api/download/models/344345", 'name': "clothed masturbation_V2.safetensors"}],
    ...
    "PornMaster-Pro FULL-V4-inpainting": [{'url': "https://civitai.com/api/download/models/102709", 'name': "pornmasterProFULLV4_fullV4-inpainting.safetensors"}],
